<?php
  ...
  echo "\nYour $riel riel were changed for $usd_from_riel usd.";

  $usd_from_kyat = $kyat * $kyat_to_usd;
  echo "\nYour $kyat kyat were changed for $usd_from_kyat usd.";

  $usd_from_krones = $krones * $krones_to_usd;
  echo "\nYour $krones krones were changed for $usd_from_krones usd.";

  $usd_from_lek = $lek * $lek_to_usd;
  echo "\nYour $lek lek were changed for $usd_from_lek usd.";
